...
translate([60, 0]) openBrick_plate_array(2, 4);

translate([80, 0]) openBrick_plate_map(
	[[1,1,0],
	 [1,1,1],
	 [1,0,1],
	 [0,1,1]]
...
translate([60, 40]) openBrick_plate_array(2, 4, studs=false);

translate([80, 40]) openBrick_plate_map(
	[[1,1,0],
	 [1,1,1],
	 [1,0,1],
	 [0,1,1]],
